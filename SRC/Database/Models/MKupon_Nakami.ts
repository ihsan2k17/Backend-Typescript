...
export interface IKupon_Nakami {
    ID: number;
    NamaCustomer: string;
    Kupon: Number;
    KuponOld: number;
...
export class Kupon_Nakami extends Model<IKupon_Nakami>{
    public ID?: number;
...
export class SaveKupon_NakamiVM{
    public ID?: number;
