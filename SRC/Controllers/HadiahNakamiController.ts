...
import { SaveHadiah_NakamiVM } from "../Database/Models/MHadiah_Nakami";


export interface IHadiahNakamiController {
...
@injectable()
class HadiahNakamiController implements IHadiahNakamiController {
    private _hadiah: IHadiahNakamiService;
    constructor(
        @inject('IHadiahNakamiService') shadiah:IHadiahNakamiService
    ) {
        this._hadiah = shadiah;
    }

    async add(req: Request, res: Response): Promise<Response> {
        const entity = req.body as SaveHadiah_NakamiVM;
        try {
    ...
    async update(req: Request, res: Response): Promise<Response> {
        const barang = req.params.Barang;
        const bodyupdate = req.body as SaveHadiah_NakamiVM;
        try {
...
export default HadiahNakamiController