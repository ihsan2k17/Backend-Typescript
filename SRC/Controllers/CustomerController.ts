...
import { SaveCustomerVM } from "../Database/Models/MCustomers";
...
class CustomerController implements ICustomerController{
    ...
    private _customer: ICustomerService;
    constructor(@inject("ICustomerService") customer: ICustomerService) {
